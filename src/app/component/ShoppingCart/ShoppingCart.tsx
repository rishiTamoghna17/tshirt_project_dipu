      ...
      <div className="flex flex-row  w-full justify-between ">
          ...
          <div className="flex flex-col w-full">
            <div className="flex flex-col gap-6 w-full">
              {cartItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-white flex flex-row  justify-between rounded-lg shadow-md p-4"
                >
                  ...
                  <div className="flex flex-col items-end gap-5">
                    ...
                    <div className="flex items-center mt-2 p-1 justify-center  bg-gray-100 rounded">
                      <span className="mx-5 text-sm font-bold capitalize tracking-widest">qty :</span>
                      <button
        ...
        <div className="mt-6 border-2 mr-10 rounded h-[300px] w-[350px] flex flex-col justify-between shadow-md">
          ...
          <div className="flex items-center justify-between p-2">
            <p className=" font-semibold text-xl text-gray-500 ">Total MRP :-</p>
          <p className="text-xl font-semibold text-gray-500 ">
             ${getTotalPrice().toFixed(2)}
          </p>
          </div>
          <div className="flex items-center justify-between p-2">
            <p className=" font-semibold text-xl text-gray-500 ">Shipping Charges :-</p>
          <p className="text-xl font-semibold text-gray-500 ">
             ${getTotalPrice().toFixed(2)}
          </p>
          </div>
          ...
          <div className="flex items-center justify-between p-2">
            <p className=" font-semibold text-xl text-gray-800 ">Sub Price :-</p>
          ...
          <div className="flex flex-row items-center justify-between p-2">
            <p className="font-semibold text-xl text-gray-500">Total - <span className="font-semibold text-xl text-gray-800">${getTotalPrice().toFixed(2)}</span></p>
